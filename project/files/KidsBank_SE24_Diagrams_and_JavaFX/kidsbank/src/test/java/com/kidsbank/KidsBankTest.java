...
/**
 * JUnit 5 tests for core business logic — TDD approach.
...
public class KidsBankTest {
    ...
    @BeforeAll
    static void setup() {
        // Must run before JsonStorage is first loaded (before any service touches storage)
    ...
    @AfterAll
    static void cleanup() {
        File dir = new File(System.getProperty("kidsbank.datadir", "test-data"));
        ...
        dir.delete();
        System.clearProperty("kidsbank.datadir");
    }
