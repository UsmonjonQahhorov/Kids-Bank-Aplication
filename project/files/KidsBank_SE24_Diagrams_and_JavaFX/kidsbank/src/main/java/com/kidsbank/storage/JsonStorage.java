 ...
 * All data is stored in plain JSON files under a data directory (default {@code data/}).
 * Set system property {@code kidsbank.datadir} before first use (e.g. in tests) to override.
 * Group SE-24 - Virtual Bank for Kids
 */
public class JsonStorage {

    private static String dataDir() {
        return System.getProperty("kidsbank.datadir", "data");
    }
