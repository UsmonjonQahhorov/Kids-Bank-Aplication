...
public class TransactionScreen {
    ...
    private void buildUI() {
        ...
        filterBar.getStyleClass().add("kidsbank-filter-row");
        ...
        filterLbl.setTextFill(Color.web("#0E2847"));
        ...
        // Transaction list
        listBox = new VBox(0);
        listBox.getStyleClass().add("kidsbank-body");
    ...
    private HBox buildRow(Transaction tx, boolean even) {
        ...
        descLbl.setTextFill(Color.web("#0E2847"));
