...
public class SavingsGoalScreen {
    ...
    private void buildUI() {
        ...
        content.getStyleClass().add("kidsbank-body");
        ...
        scroll.getStyleClass().add("kidsbank-scroll");
        scroll.setFitToWidth(true);
        scroll.setStyle("-fx-background-color:#EBF3FB; -fx-background:#EBF3FB;");
    ...
    private VBox goalCard(SavingsGoal goal, boolean completed) {
        ...
        pb.setPrefHeight(16);
        pb.setStyle("-fx-accent:" + (completed ? "#1E8449" : "#2E75B6") + ";");
    ...
    private void showAddMoneyDialog(SavingsGoal goal) {
        ...
        MainApp.styleDialogPane(td.getDialogPane());
    ...
    private Label sectionLbl(String text) {
        ...
        lbl.setTextFill(Color.web("#0E2847"));
        lbl.setStyle("-fx-text-fill:#0E2847;");
